...
export default function About() {
  return (
    <Stack spacing={5}>
      ...
      <Text>
        <strong>Marketing and Booking:</strong> We will promote your property on top short-term
        rental platforms such as Airbnb, Booking.com, and Expedia. Our team will manage all
        communication with guests, handle booking requests, and coordinate check-ins and check-outs.
      </Text>
      ...
      <Text>
        ...
        adjust prices based on demand, seasonality, and other factors to ensure that you maximize
        your rental income.
      </Text>
      ...
      <Text>
        At our company, we pride ourselves on our professionalism, attention to detail, and
        commitment to excellence. We know that your property is your investment, and we will treat
        it with the utmost care and respect.
      </Text>
      <Text>
        If you're ready to take your short-term rental business to the next level, contact us today
